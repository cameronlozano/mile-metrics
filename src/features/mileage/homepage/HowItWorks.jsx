  ...
  return (
    <div className='bg-color-bg flex flex-col border-t-2 border-b-2 border-gray-400/20 pt-4 shadow-sm lg:h-65 lg:pl-11.25'>
      <div className='flex flex-col justify-center pb-10 lg:w-125 lg:items-center'>
        <p className='text-color-subtle mx-auto text-(length:--font-11px) uppercase lg:pl-1 lg:font-medium lg:tracking-wider'>
          Make more on every mile
        </p>

        <div className='flex justify-evenly pb-1.5 text-(length:--font-28px) font-bold tracking-wide text-gray-700 lg:gap-5 lg:text-(length:--font-50px)'>
          <h2>Drive.</h2>
          <h2>Track.</h2>
          <h2>Save.</h2>
        </div>
